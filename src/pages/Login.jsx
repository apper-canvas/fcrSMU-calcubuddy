...
import { loginUser } from '../services/apperService';
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      dispatch(setError(error.message || 'Invalid email or password'));
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-surface-50 dark:bg-surface-900 p-4">
      ...
      >
        ...
        <div className="bg-white dark:bg-surface-800 rounded-2xl shadow-soft p-8">
          ...
          {useApperUI ? (
            <div id="authentication" className="min-h-[300px] flex items-center justify-center" />
          ) : (
